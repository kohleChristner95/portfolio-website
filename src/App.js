      ...
      <div className="empty-color full-height row">
        ...
        <div className="label col-sm-4">
          ...
          <div style={{ lineHeight: 1.7 }}>
            ...
            <a href="https://fireflyint.com/">Firefly Integrations</a>. Being
            self taught, I have a huge passion for learning and expanding my
            programming skills. I have experience using javascript with ionic
